...
@can('link_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <h2 class="d-inline-block align-middle">{{ trans('cruds.link.title_singular') }}</h2>
            <a class="btn btn-success float-right" href="{{ route('admin.links.create') }}">
                {{ trans('global.add') }} 
            </a>
        </div>
    </div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-striped table-hover datatable datatable-Link">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" style="width: 150px !important;">
