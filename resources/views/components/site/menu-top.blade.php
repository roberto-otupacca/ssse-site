        ...
        <nav class="container mx-auto">
          <div class=" flex flex-wrap items-center">
            ...
            <div class="flex pl-3 mx-auto text-white font-extrabold
                  ...
                  <a href="{{url('/')}}" class="
                  {{intval(session('settings')->where('name', 'menurows')->where('val', '1')->count())?'lg:mt-0 lg:mb-0':''}}">
                  ...
                  <ul class="list-reset flex justify-between flex-1 items-center
                      ...
                      @foreach($menuItems as $menuItem)
                        @if (Request::segment(1) == $menuItem->slug || (is_null(Request::segment(1)) && $menuItem->slug == "home"))
                          <li class="mr-3">
                            <div class="cursor-default inline-block py-2 px-4 dark:text-white no-underline line-clamp-1
                        ...
                        @else
                          <li class="mr-3">
                            <a class="inline-block py-2 px-4 no-underline border-t-8 line-clamp-1
