...
class FilesController extends Controller
{
    ...
    public function index()
    {
        ...
        $files = File::with(['pages', 'category', 'media'])->get();

        $pages = Page::get();

        $categories = Category::get();

        return view('admin.files.index', compact('files', 'pages', 'categories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.files.create', compact('pages', 'categories'));
    }
    ...
    public function edit(File $file)
    {
        ...
        $file->load('pages', 'category');

        return view('admin.files.edit', compact('pages', 'categories', 'file'));
    }
